...
$string['anonymization_triggered_desc'] = 'The user with id \'{$a}\' triggered anonymization for all deleted users.';
...
$string['event_anonymization_triggered'] = 'Anonymization of all deleted users triggered.';
