...
$string['anonymization_triggered_desc'] = 'The the user with id \'{$a}\' was anonymized.';
...
$string['default_firstname'] = 'deleted';
$string['default_lastname'] = 'user';
$string['delay'] = 'Delay';
$string['delay_desc'] = 'Days between deletion and anonymization of user data';
$string['event_anonymization_triggered'] = 'User anonymized.';
$string['plugin_setting'] = 'Delay for anonymizing user data';
$string['pluginname'] = 'Deleted user anonymizer';
...
$string['userandomname'] = 'Use random name';
$string['userandomname_desc'] = 'If enabled, deleted users are anonymized using a random combination of an adjective and an animal. If disabled, the fixed replacement values "deleted user" are used instead.';
