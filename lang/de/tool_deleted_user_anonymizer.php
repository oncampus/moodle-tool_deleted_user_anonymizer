...
$string['anonymization_triggered_desc'] = 'Der Nutzer mit der id \'{$a}\' wurde anonymisiert.';
...
$string['default_firstname'] = 'gelöschte/r';
$string['default_lastname'] = 'Nutzer/in';
$string['delay'] = 'Verzögerung';
$string['delay_desc'] = 'Tage zwischen Löschung und Anonymisierung der Userdaten';
$string['event_anonymization_triggered'] = 'Nutzerkonto anonymisiert.';
$string['plugin_setting'] = 'Verzögerung der Anonymisierung von Nutzerdaten';
$string['pluginname'] = 'Anonymisierung gelöschter Nutzer';
...
$string['userandomname'] = 'Zufälligen Namen verwenden';
$string['userandomname_desc'] = 'Wenn aktiviert, werden gelöschte Nutzer/innen mit einer zufälligen Kombination aus Adjektiv und Tier anonymisiert. Wenn deaktiviert, werden stattdessen die festen Ersatzwerte "gelöschte/r Nutzer/in" verwendet.';
